            ...
            <div class="col-sm-3 col-md-3">
                <ul>
					...
					<li>
						<a href="#" data-toggle="modal"
							data-target="#loginModal"
							class="showregister" rel="station"> Station Registration</a>
					</li>
					@endif
					@if (Auth::check())
 					<li>
					...
					@else
					<li>
						<a href="javascript:void(0)" class="role_type_log show_fm" rel="fairmode"> Fair Mode Registration </a>
					</li>
					@endif
					@if (Auth::check())
  					<li>
					...
					@else
					<li>
						<a href="javascript:void(0)"  class="role_type_log show_ep" rel="humancap"> Employee Benefit Registration </a>
					</li>
					@endif					
