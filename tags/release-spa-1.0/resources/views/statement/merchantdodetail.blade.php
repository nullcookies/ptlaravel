...
@section("content")
    ...
    <div class="container" style="margin-top: 30px;margin-bottom: 30px;">
        <div class="statement" style="">
            <h2 style="font-family: sans-serif">Delivery Orders</h2>
            ...
            <div class="ym">
                ...
                <?php } ?>
                @foreach($dos as $do)
                    {{--*/ $created_at = new Carbon\Carbon($do->created_at); $carbon = new Carbon();
        ...
        <div class="modal fade" id="stModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document" style="width:96%">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h2 class="modal-title" id="myModalLabel2">Station Statement</h2>
                    </div>
