						...
						<div class="panel with-nav-tabs panel-default ">
							<div class="panel-heading">
								<ul class="nav nav-tabs">
									...
									<li id="tb-product-list" ><a href="#return-status" data-toggle="tab">Debit Note Status</a></li>
									<li id="tb-product-list" ><a href="#merchant-approval" data-toggle="tab">Merchant Approval</a></li>
