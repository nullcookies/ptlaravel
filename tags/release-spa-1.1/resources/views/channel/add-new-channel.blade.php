        ...
        <div class="container"><!--Begin main cotainer-->
            <div class="row">
                ...
                <div class="col-sm-11 col-sm-offset-1">
                    {!! Form::open(array('url'=> Route::current()->getName() , 'files' => 'true', 'method'=>'post', 'id'=>'registe_rForm' , 'class'=> 'form-horizontal')) !!}
                    ...
                    <div id="account">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                {!! Form::password('password', array('placeholder'=>'Password', 'class' => 'form-control validator','id'=>'pass')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('confirmPassword', 'Confirm Password', array('class' => 'col-sm-2 control-label')) !!}
                            <div class="col-sm-6">
                                {!! Form::password('confirmPassword', array('placeholder'=>'Confirm Password', 'class' => 'form-control validator','id'=>'compass')) !!}
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div id="company">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                {!! Form::select('domicile', [''=>'Country of Origin']+$cf->getCountry(), $userModel['station'][0]['country_id'], [ "data-bv-trigger" => "keyup" , "required" => "required", 'class' => 'validator form-control',$disabled]) !!}
                            ...
                            <div class="col-sm-5">
                                {!! Form::text('gst', $userModel['station'][0]['gst'], array( "data-bv-trigger" => "keyup" , "required" => "required", 'placeholder'=>'Input Your GST/VAT Number', 'class' => 'validator form-control',$disabled))!!}
                            </div>
                        </div>
                        <div id="dirDetail" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                {!! Form::select('business_type', $cf->getBusinessType(), $userModel['station'][0]['business_type'], ['class' => 'form-control validator',$disabled]) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control validator" name="business_reg_no" value="{{$userModel['station'][0]['business_reg_no']}}" placeholder="Type Business Number" {{$disabled}}>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div id="contact">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text " required="" name="contact" value="{{ $userModel['station'][0]['contact_person']}}" class="form-control validator" >
                                </div>
                                <label class="col-sm-1 control-label">Office: </label>
                                <div class="col-sm-2">
                                    <input type="text" required="" name="office"  value="{{ $userModel['station'][0]['office_no']}}" class="form-control">
                                </div>
                                <label class="col-sm-1 control-label">Mobile: </label>
                                <div class="col-sm-2">
                                    <input type="text" required="" name="mobile"  value="{{ $userModel['station'][0]['mobile_no']}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div id="station">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="station_name" class="form-control validator" value="{{$userModel['station'][0]['company_name']}}" placeholder="Input your Station Name"  {{$disabled}}>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Station Description: </label>
                                <div class="col-sm-9">
                                    <!-- <p class="text-muted">Provide us with a brief description of your business to help us</p> -->
                                    <textarea id="textarea" maxlength="255" name="description" class="form-control validator" placeholder="Provide us with a brief description of your business to help us"  {{$disabled}}>{{ $userModel['station'][0]['description']}} </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    '1' => 'Yes', '0' => 'No'],$userModel['station'][0]['license'], ['class' => 'form-control'] ) !!}
                                </div>
                                <div class="clearfix">&nbsp;</div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    'internationally'=>'Internationally'],$userModel['station'][0]['coverage'], ['class' => 'form-control'] ) !!}
                                </div>
                                <div class="clearfix">&nbsp;</div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    '1' => 'Yes', '0' => 'No'],$userModel['station'][0]['ownership'], ['class' => 'form-control'] ) !!}
                                </div>
                                <div class="clearfix">&nbsp;</div>
                                <label class="col-sm-6 control-label">What is the category of the products you are selling? </label>
                                <div class="col-sm-6">
                                    {!! Form::select('category', $cf->category(), $userModel['station'][0]['category_id'], ['class' => 'form-control']) !!}
                                </div>
                                <div class="clearfix">&nbsp;</div>
                                <label class="col-sm-6 control-label">How many products you plan to sell? </label>
                                <div class="col-sm-6">
                                    <!-- {!! Form::select('sell_plan', ['' => 'Choose Option',
                                '50' => 'Less than 50', '500' => 'Less than 500'],$userModel['station'][0]['planned_sales'], ['class' => 'form-control'] ) !!} -->
                                    {!! Form::select('sell_plan', ['' => 'Choose Option',
                                    '50' => '<50', '500' => '51-500', '2000' => '501-2000', '5000'=>'>2000'],$userModel['station'][0]['planned_sales'], ['class' => 'form-control'] ) !!}
                                </div>
                                <div class="clearfix">&nbsp;</div>
                            </div>
                            <hr>
                        ...
                        <div class="row" id="location">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-5 control-label">Country: </label>
                                    <div class="col-sm-7">
                                        {!! Form::select('country', [''=>'Country of Origin']+$cf->getCountry(), $userModel['address'][0]['city_id'], ['class' => 'form-control validator','id' => 'station_country_id']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-5 control-label">State: </label>
                                    <div class="col-sm-7">
                                        @if(isset($userModel['address'][0]['city_id']))
                                            {!! Form::select('state', $cf->getState(),$userModel['address'][0]['city_id'], ['class' => 'form-control']) !!}
                                        @else
                                            <select class="form-control validator" id="station_states" required></select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        @if(isset($userModel['address'][0]['city_id']))
                                            {!! Form::select('city_id', $cf->getCity(), $userModel['address'][0]['city_id'], ['class' => 'form-control']) !!}
                                        @else
                                            <select class="form-control validator" id="station_cities" name="city_id" required></select>
                                        @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="line1" id="street" class="form-control validator" value="{{ $userModel['address'][0]['line1']}}" placeholder="348 Jalan Tun Razak, Kuala Lumpur, Malaysia">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-7">
                                <div id="map-container" class="custom-container" style="width:575px; height:435px;">
                            ...
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea('remarks', $userModel['station'][0]['remarks'], array('class' => 'form-control'))!!}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div id="remarksattach" class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 col-xs-12">
                                                    <div class="inputBtnSection">
                                                        <input id="uploadFileRem" class="disableInputField" value="{{ $DOC->path }}" placeholder="Add New Attachment" {{$disabled}} />
                                                        <label class="fileUpload">
                                                            <input id="uploadBtnRem" name="Remarksupload_attachment[]" type="file" class="upload" required {{$disabled}}/>
                                                            <span class="uploadBtn">Upload </span>
                                                        </label>
                                                    </div>
                        ...
                        <div class="pull-right">
                            ...
                            {!! Form::submit('Submit', array('class' => 'btn btn-green','id' => 'reg_station')) !!}
...
@section('scripts')
    ...
    <script src="<?php echo url();?>/js/station.js"></script>
@stop