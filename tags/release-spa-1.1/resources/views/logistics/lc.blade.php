...
<h2>Logistic Merchant Company Master</h2>
<table class="table table-bordered" cellspacing="0" width="100%" id="cre_details_table">
                ...
                <tbody>
                	...
                	<tr>
						...
						<td class="text-right">{{$currentCurrency}}&nbsp;{{number_format($l->total_delivery/100,2)}}</td>
                        <td class="text-right">{{$currentCurrency}}&nbsp;{{number_format($l->total_delivery_up/100,2)}}</td>	
                	</tr>
                	<?php $i++;?>
