                            ...
                            <div class="productprice">
                                ...
                                @if ($product->discounted_price == 0)
                                    @if ($product['retail_price'] != 0)
										{{$currentCurrency}} {{number_format($product['retail_price']/100,2)}}
										<br>
										<span>&nbsp;</span>
                                    @endif
                                @else
                                    <span style="font-weight:normal;">{{$currentCurrency}}</span><strike style="color:red; font-weight:normal"> <span style="color:#333;">{{number_format($product['retail_price']/100,2)}} </span></strike>
