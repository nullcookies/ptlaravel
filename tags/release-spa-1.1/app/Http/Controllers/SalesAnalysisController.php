    ...
    public function getMerchantData(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            try {
                ...
                $totalWeelPayment=$this->totalKV($weekPerformance,"sales");
                $totalWeekDeals=$this->totalKV($weekPerformance,"ordercount");
    ...
    */ 
    ...
    public function getMerchantMTDPerformance($merchant_id)
    {
        ...
        return DB::select(DB::raw(
                ...
                WHERE 
                DATE(porder.updated_at) BETWEEN  ' $startmonth ' AND ' $endmonth '
    ...
    { 
        ...
        return DB::select(DB::raw(
                ...
                WHERE 
                DATE(porder.updated_at) BETWEEN  ' $fromDate ' AND ' $toDate '
