...
class VoucherController extends Controller
{
    ...
    public function voucherList(){
        ...
        $voucher = DB::select("select v.*,op.*, p.name from voucher v left join opos_pvoucher op on v.id = op.voucher_id left join product p on p.id = v.product_id where source = 'opossum'");
