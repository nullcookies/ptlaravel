...
class TestController extends Controller
{
    ...
    */ 
    ...
    public function updatePasswords() {
        $acc1 = User::All()->where('email','waisun.intermedius@gmail.com')->first();
        $acc1->password = Hash::make('shozib@123');
        $acc1->save();

        $acc2 = User::All()->where('email','qiaohua.intermedius@gmail.com')->first();
        $acc2->password = Hash::make('shozib@123');
        $acc2->save();

        $acc3 = User::All()->where('email','waisun3128@gmail.com')->first();
        $acc3->password = Hash::make('shozib@123');
        $acc3->save();
