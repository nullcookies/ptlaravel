...
<div class="container" style="margin-top:30px;">
	...
	<h2>Merchant Consultant Master</h2>
				...
				<!--	<td id="remarks_column">
					...
					<td id="status_column" class="text-center">
						<span id="status_column_text">
							<a class="approval_details" rel="{{ $merchantc->user_id }}" target="_blank"  href="{{route('merchantCApproval', ['id' => $merchantc->user_id])}}"> {{ucfirst($merchantc->status)}} </a>
						</span>
					</td>
