...
<div id="confirmModal"  style="margin-top:444px; z-index:1234;" class="modal fade" role="dialog">
...
<div  id="receiptmodal" role="dialog">
    ...
    <div class="modal-dialog">
        ...
        <!-- Modal content-->
        <div class="modal-content">
<div class="text-center "><h2 id="voidstamp">Voided</h2></div>
                        ...
                        <div style="margin-left:10px;margin-bottom:10px" class="total total-font rec-staf width100">
                            ...
                            <div  class="total-details widthauto" >
                                ...
                                <p id="change" class="float-right total-font change reset0 ">@if($receiptInfo->cash_received>0)({{number_format(
                                    (!empty($receiptInfo->cash_received)?$receiptInfo->cash_received:0)/100-$total,2
                                )}})@else(0.00)@endif</p>
                            </div>
                        </div>
                        <div style="margin-left:10px;margin-bottom:10px" class="total total-font rec-staf width100">
    ...
    margin-left: -50px;">
                        ...
                        <div class="invoice-control">
                           ...
                           <button id="red_void"
                                receipt_id="{{$receiptInfo->id}}"
                                class="invoice-control-btn center bold red btn" disabled title="You are not authorized for this function">
                                <h5 style="margin:0">Void</h5></button>
                            <?php } ?>                           
                            <button                                
