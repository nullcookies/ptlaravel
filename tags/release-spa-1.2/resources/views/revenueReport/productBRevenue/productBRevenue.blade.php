    ...
    <div class="container" style="margin-top:30px; height:auto;">
     ...
     colors: ['#595959', '#FF0000', '#818E56', '#953822', '#538DD3', '#A5A8AD']
			...
			var options = {
	            ...
	            title: {
	                text: 'Product B Revenue Pie- {{ date("Y")}}'
	            },
	            tooltip: {
	                formatter: function() {
        ...
        enabled: true
	        ...
	        $.getJSON("{{ URL::to('/')}}/productBRevenueJSON/json", function(json) {
	...
	<table id="revenueDatatable" class="display table table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th style="background-color:#595959; color:#fff">Sales</th>
                <th style="background-color:#FF0000; color:#fff">Retail</th>
                <th style="background-color:#818E56; color:#fff">B2B</th>
                <th style="background-color:#953822; color:#fff">Export</th>
                <th style="background-color:#538DD3; color:#fff">O-Warehouse</th>
                <th style="background-color:#A5A8AD; color:#fff">OEM/ODM</th>
