                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="row margin-top">
                                                ...
                                                <div class="col-sm-4">
                                                    <select style="width: 100%;" class="form-control selectpicker show-menu-arrow" id="billing_cities" name="billingcity_name" data-style="btn-green" >
                                                        <option value="">Choose Option</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="row margin-top">
                                                ...
                                                <div class="col-sm-4">
                                                    <select style="width: 100%;" class="form-control selectpicker show-menu-arrow" id="delivery_cities" name="deliverycity_name" data-style="btn-green" >
                                                        <option value="">Choose Option</option>
