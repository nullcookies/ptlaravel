				...
				<tfoot>
					<tr>
						...
						@if($product->status == 'deleted')
							<th style="width: 220px !important" colspan=2>
								<p align="center">
									<button class='btn btn-danger btn-sm btn-transfer' style="width: 120px;" disabled rel="{{$product->id}}">Transfer</button>
									<button class='btn btn-info btn-sm btn-copy' style="width: 120px;" disabled rel="{{$product->id}}">Copy</button>
								</p>	
							</th>
						@else
							<th style="width: 220px !important" colspan=2>
								<p align="center">
									<button class='btn btn-danger btn-sm btn-transfer' style="width: 120px;" rel="{{$product->id}}">Transfer</button>
									<button class='btn btn-info btn-sm btn-copy' style="width: 120px;" rel="{{$product->id}}">Copy</button>
								</p>
							</th>
						@endif
					</tr>
				...
				if(oshop == ""){
					...
					$.ajax({
						...
						success: function (data) {
							...
							if(copyvv == 1){
								toastr.info('Product Successfully Copied');
							} else {
