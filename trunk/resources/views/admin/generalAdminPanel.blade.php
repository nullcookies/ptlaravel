...
<li><a href="{{route('generalIndexPaymentGateway')}}">Payment Gateway</a></li>
<li><a href="{{route('generalIndexStationType')}}">Station Type</a></li>
<li><a href="{{route('Mass_autolink')}}">MSLinking</a></li>
<li><a href="{{route('stationselectionan')}}">Station Rotation Intelligence</a></li>
<li><a href="{{route('giroReader')}}">OCBC Giro Reader</a></li>
...
-->
<li><a href="{{route('advert')}}">Advertisement</a></li>
<li><a href="{{route('footerSectionAMgmt')}}">Footer: Section A</a></li>
<li><a href="{{route('footerSectionBMgmt')}}">Footer: Section B</a></li>
<li><a href="{{route('newsletterMgmt')}}">News Letter</a></li>
<li><a href="{{route('directoryMgmt')}}">Directory</a></li>
<li><a href="{{route('generalIndexOpenSupport')}}">OpenSupport</a></li>
{{--<li><a href="{{route('usersMgmt')}}">Users</a></li>--}}
{{--<li><a href="{{route('AdminDownloadApps')}}">Download Apps</a></li>--}}
{{--<li><a href="{{route('buyerhelpMgmt')}}">Buyer Help</a></li>--}}
{{--<li><a href="{{route('sellerhelpMgmt')}}">Seller Help</a></li>
{{--<li><a href="{{route('AdminAboutUs')}}">About Us</a></li>--}}
{{--<li><a href="{{route('AdminTermsAndCondition')}}">Terms & Condition</a></li>--}}
