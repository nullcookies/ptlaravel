                            ...
                            <div id="dashboard" class="row panel-body"
								...
								<div class="tab-pane fade" id="product-detail">
									...
									<button class="btn btn-info pull-right sellerbutton"
										style="margin-top:-40px;margin-bottom:10px;margin-right:0;padding-top: 7px;background:#275c85;border-color:transparent;"
										...
										<button class="btn btn-info pull-right sellerbutton" data-toggle="modal" data-target="#ImportModal"
												style="margin-top:-40px;margin-bottom:10px;margin-right:5px;padding-top: 7px;background:#d53f45 ;border-color:transparent;"
										...
										<button class="btn btn-info pull-right sellerbutton" data-toggle="modal" data-target="#ExportModal"
											style="margin-top:-40px;margin-bottom:10px;margin-right:5px;padding-top: 7px;background:#186000;border-color:transparent;   "
		...
		//	product_table.destroy();
			...
			for(var jk = 0; jk < products.length; jk++){
				...
				//	console.log(oshoid);
					...
					html +=  '<td data-action="update" class="xxlarge" data-rowid="'+product.id+'" data-columnname="name" data-tablename="Product" data-value="'+product.category_id+'"><img src="'+JS_BASE_URL+'/images/product/'+product.id+'/'+product.photo_1+'" width="30" height="30" style="padding-top:0;margin-top:4px">&nbsp;<span style="vertical-align: middle;" title="'+pfullname+'"><a target="_blank" href="'+ JS_BASE_URL + '/album/'+ product.id +'" class="product_popup" rel="'+product.id+'">'+pname+'</a></span>';				
					html += '</td>';
