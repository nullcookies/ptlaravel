		...
		<div class="tab-content top-margin" style="margin-top:-30px">
			...
			<div id="customers" class="tab-pane fade in active">
				<div class="row">
					...
					<div class=" col-sm-6">
						<a class="add_row_c btn btn-info pull-right" style="text-align:center;margin-left: 5px; width: 120px;border-radius:5px"
							href="javascript:void(0)">+ Customer</a>&nbsp;
						@if(Auth::user()->hasRole('adm'))
							<a class=" btn btn-danger pull-right" style="text-align:center;margin-left: 5px; width: 120px;border-radius:5px"
						...
						<a class="channel_managment btn btn-info pull-right" 
							...
							!important; border-color: #948A00 !important;border-radius:5px;text-align:center;"
							href="javascript:void(0)">+ Channel</a>&nbsp;
						<a class="segment_managment btn btn-info pull-right"
							style="margin-left: 5px; width: 120px;text-align:center ;background-color: #595959 !important; border-color: #696969 !important;border-radius:5px"
							...
							@foreach($customers as $emps)
								<tr>
									...
									$pfullnote="Name";
										...
										if($pfullnote == " " || is_null($pfullnote)){
											$pfullnote="Name";
									...
									?> 
									<a rel-customer-info={{$emps->id}} class="add_customer_info"   id="add_customer_info" name="add_customer_info"> {{$pfullnote}}</a>
									...
									<td class="text-center" style="vertical-align:middle;">
										...
										@else
											<a href="javascript:void(0)" style="vertical-align:middle;" class="customer_role" rel="{{$emps->user_id}}">Roles</a>
										@endif
									</td>
									<td class="text-center" style="vertical-align:middle;" >				
										<a  class="details_button"  rel-customer={{$emps->id}} id="details_button" name="details_button">
											Details
										</a>
									</td>
									<td class="text-center" style="vertical-align:middle;">
									...
									<td class="text-center" style="vertical-align:middle;">{{$emps->email}}</td>
									<td class="text-center" style="vertical-align:middle;">
									...
									<td class="text-center" style="vertical-align:middle;"><span id="segments{{$emps->id}}">{{$emps->segments}}</span></td>
								</tr>
							<?php $e++;?>
							@endforeach
							</tbody>
					...
					<div class="modal-content" style=" font-family: sans-serif;">
						<div class="modal-header">
						  ...
						  <h4 class="modal-title" style="font-family: sans-serif;"
							  id="addInfoModalLabel">Customer Information</h4>
						  </div>
						  <div class="modal-body">
							  <form method="post" id="add_info_form" action="/addcustomerdetail">
									<input type="text" name="cus_member_id" value="">
						  <div> <label></label></div>
						  <div class="col-md-12">
								<label class="col-md-4">Merchant Details</label></div>
						  <div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="company_name" placeholder="Company Name"/> </div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="bs.no" placeholder="Business Registration Number"/> </div>
							<div class="col-md-12">
									<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="address1" placeholder="Address Line 1"/> </div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="address2" placeholder="Address Line 2"/> </div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="address3" placeholder="Address Line 3"/> </div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="state" placeholder="State"/> </div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="city" placeholder="City"/> </div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="postal_code" placeholder="Postal Code"/> </div>
							<div> <label></label></div>
							
							<div class="col-md-12">
								<label class="col-md-4">Contact Person</label></div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="name" placeholder="Name"/> </div>	
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="c_address1" placeholder="Address Line 2"/> </div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="c_address2" placeholder="Address Line 3"/> </div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="c_state" placeholder="State"/> </div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="c_city" placeholder="City"/> </div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="c_postal" placeholder="Postal Code"/> </div>
							<div class="col-md-12">
								<input style="margin-left:13px;margin-bottom:3px;" class="col-md-8" type="text" name="c_mobile" placeholder="Mobile"/> </div>																											
    ...
    <div class="modal-content" style=" font-family: sans-serif;">
      <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"
			...
			<span aria-hidden="true">&times;</span></button>
		<h4 class="modal-title" style="font-family: sans-serif;"
			id="myModalLabel">User Name</h4>
		</div>
		<div class="modal-body">
			<form action="/add_customer_details" id="action_form_data"  method="post">
				<input type="text" name="cust_id" id="cust_id" hidden>
				
		<div> <label></label></div>
		<div class="col-md-12">
			<label class="col-md-4">Customer ID</label><span id="customer_id"> </div>
		<div class="col-md-12 ">
			<label class="col-md-4">Segment</label></div>
		...
		<div class="col-md-12">
			<label class="col-md-4">Roles</label> </div>
			...
			@endforeach</div> --}}
		<div class="col-md-12">
			<label class="col-md-4">Action</label><input type="text" name="action"/> </div>
		<div class="col-md-12">
			<label class="col-md-4">Stage</label>
			<label class="col-md-6">
				</label><input type="text" name="stage"/></div>
		<div class="col-md-12">
			<label class="col-md-4">Remark</label>
			<label class="col-md-6">
			</label>
				<textarea type="text" cols="30" rows="4" name="remarks"></textarea>
				</div>
		<div class="clearfix" ></div> 
		</div>
		<div class="modal-footer">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="    font-family: sans-serif;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="status_form();"
...
$("body").on("click",".add_customer_info",function(){
	...
	$("input[name=cus_member_id]").val($customer_id);
					...
					<div class="modal-content" style=" font-family: sans-serif;">
						<div class="modal-header">
						  <button type="button" class="close" data-dismiss="modal"
							  ...
							  <span aria-hidden="true">&times;</span></button>
						  <h4 class="modal-title" style="font-family: sans-serif;"
							  id="addStaffModalLabel">Add Staff</h4>
						  </div>
						  <div class="modal-body">
						  	<div class="row">
						  		<div class="col-sm-2">
						  			<input type="text" class="form-control" name="userid" id="asuserid" placeholder="User ID">
						  		</div>
						  		<div class="col-sm-3">
						  			<input type="text" class="form-control" name="asemail" placeholder="Email">
						  		</div>
						  		<div class="col-sm-3">
						  			<input type="text" class="form-control" name="asnickname" placeholder="Nickname">
						  		</div>
						  		<div class="col-sm-3">
						  			<input type="text" class="form-control" name="asloginno" placeholder="Login No.">
						  		</div>
						  		<div class="col-sm-1">
							...
							<div class="col-md-8"> 
								...
								<input type="text" class="form-control" name="line3" placeholder="Address Line 3">
								...
								<input type="text" class="form-control" name="email" placeholder="Alternate Email">
