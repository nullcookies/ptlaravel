        ...
        <div class="row">
            <div class="col-sm-12">
                <div id="main">
                    <div class="">
                        <div class="main-container">
			     	    ...
			     	    <span  id="employee-error-messages">
                                    ...
                                    <table class="table table-bordered" id='employeeTable' width="1420px">
                                        <thead>
                                        <tr class='paymentTable'>
                                            ...
                                            <th class='text-center bmedium' style="background-color: #CCC;">LHND&nbsp;(PCB)</th>
                                            <th class='text-center bmedium' style="background-color: #CCC;">KWSP/EPF</th>
                                            <th class='text-center bmedium' style="background-color: #CCC;">SOCSO</th>
					...
					[{!! str_pad($employees[0][$w]->emp_id, 10, '0', STR_PAD_LEFT) !!}]
							...
							<a href="{{route('employeepaydetails', ['id' => $employees[0][$w]->emp_id])}}" target="_blank" onclick="window.open('{{route('employeepaydetails', ['id' => $employees[0][$w]->emp_id])}}'); return false;" class="emppayment_details" rel="{{$employees[0][$w]->emp_id}}">Details</a>
                                                    ...
                                                    <td class="text-center">
                                                        {{ UtilityController::s_date($employees[0][$w]->payment_at) }}
                                                    </td>												
                                                </tr>
                                            @endfor
                                            </tbody>
