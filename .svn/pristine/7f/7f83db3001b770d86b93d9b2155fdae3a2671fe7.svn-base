...
include_once("Routes/wastageRoute.php");
...
Route::group(['prefix'=>'rn/app'],function(){
    ...
    include_once("RNRoutes/LandingPageRoutes.php"); //Added by Abir
...
Route::group(['middleware' => 'admin'], function() {
 ...
 //   Route::get('admin/master/delivery', ['as' => 'delivery', 'uses' => 'DeliveryController@getDeliveryMasterDetails']);
	...
	Route::get('/seller/terminal/cash', ['as' => 'getTerminalCash', 'uses' => 'SellerHelpController@getTerminalCash']);
...
Route::group(['middleware'=>'logged'],function(){
    ...
    Route::get('stockreport/{id}', array('as' => 'Stockreport', 'uses' =>'DOController@stockreport'));
