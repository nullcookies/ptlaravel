        ...
        <div class="modal fade" id="service_repair_bookModal" role="dialog">
            <div class="modal-dialog maxwidth60" style="width:50%">
                ...
                <div class="modal-content modal-content-sku">
                    ...
                    <div id="service_repair_bookBody" style="padding-left:0;padding-right:0" class="modal-body"></div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="showchit_noModal" role="dialog">
            <div class="modal-dialog maxwidth60" style="width:50%">
                ...
                <div class="modal-content modal-content-sku">
                    ...
                    <div id="showchit_noBody" style="padding-left:0;padding-right:0" class="modal-body"></div>
                </div>
            </div>
        </div>
...
<script>
   ...
   function show_warrenty()
   {
    $.ajax({
            type: "GET",
            url: JS_BASE_URL+"/raw/show_warrenty",
