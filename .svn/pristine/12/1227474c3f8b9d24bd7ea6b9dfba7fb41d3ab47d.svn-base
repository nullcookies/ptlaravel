    ...
    <div class="row">
        ...
        <div class="col-sm-11 col-sm-offset-1">
            ...
            @if(isset($deliveryorder))
                    ...
                    {{--<span class="pull-right"><b>Tax&nbsp;Invoice&nbsp;No:</b>&nbsp;{{str_pad($array_delivery[0]['merchantrecno'],10,"0",STR_PAD_LEFT)}}</span>--}}
                    {{--</div>--}}
                    {{--</div>--}}
                    {{--</div>--}}
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <td colspan="4" class="text-right" style="height: 50px; vertical-align: inherit">
                                        <b>Purchase&nbsp;Order&nbsp;No:</b>&nbsp;{{str_pad($array_delivery[0]['merchantrecno'],10,"0",STR_PAD_LEFT)}}
                                    </td>
                                </tr>
