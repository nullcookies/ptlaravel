...
class CreateProductTable extends Migration {
	...
	public function up()
	{
		Schema::create('product', function (Blueprint $table) {
			...
			/* Business Type affecting OPOsum and PlatyPOS */
			$table->enum('business_type', ['spa','table','hotel','car',
				'restaurant']);
			...
			$table->enum('type', array('product', 'voucher','otcvoucher','platypos','service'));
