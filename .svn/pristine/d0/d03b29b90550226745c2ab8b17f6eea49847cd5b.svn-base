...
<div class="container" id="sales-analysis" style="margin-top:30px;">   
	...
	<!--	<div class="col-xs-12" id="label" >
		...
		<option value="{{ $value->code }}">{{ $value->location }}</option>
		@endforeach
		</select>
		</div>
			<!--<div class='col-xs-6 channel-merchant-select-container'>
		...
		function setskudatatable(listproducts) {
	            ...
	            var skutablerow =` <table style="width: 100%;" id="skutbl" class="table1 skutable">
	              ...
	              <tbody id="skutable-body">
	               `;
	            var i = 0;
	            var k = listproducts['0'].pricesum1 / listproducts['0'].totalProduct * 100; 	
	        ...
	        function setskudatatable(listproducts_ytd) {
	            ...
	            var skutablerow =` <table style="width: 100%; " id="skutbl" class="table1 skutable">
	              ...
	              <tbody id="skutable-body">
	               `;
	            var i = 0
	            var k = listproducts_ytd['0'].pricesum1 / listproducts_ytd['0'].totalProduct * 100;
...
/*MTD button code*/
	        ...
	        function setskudatatable1(listproducts_mtd) {
	            ...
	            var skutablerow =` <table style="width: 100%; " id="skutbl" class="table1 skutable">
	              ...
	              <thead class="bg-inventory">
	                <tr >
	                  ...
	                  <th class="text-right" scope="col">Sku</th>
	                  <th class="text-right" scope="col">npid</th>
	                  <th class="text-right" scope="col">product-merchant-select-container</th>
	                </tr>
	              </thead>
	              <tbody id="skutable-body">
	               `;
	            ...
	            var i = 0
	            var k = listproducts_mtd['0'].pricesum1 / listproducts_mtd['0'].totalProduct * 100;
	            ...
	            i++;
	                ...
	                skutablerow+= `<tr>
	                        ...
	                        <div class="progress1" style="margin: -3% 0% 1% 5%;">
							    <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="50" style="width:`+bar+`%; /* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/#b4ddb4+0,83c783+17,52b152+33,008a00+67,005700+83,002400+100;Green+3D+%231 */
									background: #b4ddb4; /* Old browsers */
									background: -moz-linear-gradient(-45deg, #b4ddb4 0%, #83c783 17%, #52b152 33%, #008a00 67%, #005700 83%, #002400 100%); /* FF3.6-15 */
									background: -webkit-linear-gradient(-45deg, #b4ddb4 0%,#83c783 17%,#52b152 33%,#008a00 67%,#005700 83%,#002400 100%); /* Chrome10-25,Safari5.1-6 */
									background: linear-gradient(135deg, #b4ddb4 0%,#83c783 17%,#52b152 33%,#008a00 67%,#005700 83%,#002400 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
									filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#b4ddb4', endColorstr='#002400',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */">
							     </div><span style="color:red;"> MYR  `+ listproducts_mtd.pricedata +`</span>
							  </div> `+listproducts_mtd.name+` </td>
	                        <td>`+listproducts_mtd.barcode+`</td>
	                        <td>`+listproducts_mtd.sku+`</td>
	                        <td>`+listproducts_mtd.npid+`</td>
	                        <td>`+listproducts_mtd.price+`</td>
	                    </tr>
	                  `;
	            });
	         } 
...
/*WTD button code*/
	        ...
	        function setskudatatable1(listproducts_wtd) {
	            ...
	            var i = 0
	            var k = listproducts_wtd['0'].pricesum1 / listproducts_wtd['0'].totalProduct * 100;
	        ...
	        /*hourly button code*/
	        function fetch_products_code_hourly(message = null) {
	            ...
	            $.ajax({
	                ...
	                type: "GET",
	                url: "{{URL('/skulist_hourly')}}",
	                success: function( listproducts_hourly ) {
	                    setskudatatable1(listproducts_hourly);

	                }
	            });
	        }

	        function setskudatatable1(listproducts_hourly) {
	        	jQuery(this).removeData();
	            var skutablerow =` <table style="width: 100%; " id="skutbl" class="table1 skutable">
	              ...
	              <tbody id="skutable-body">
	               `;
	            if(listproducts_hourly == "No data available"){
	            ...
	            else
	            {
	             ...
	             var i = 0
	            var k = listproducts_hourly['0'].pricesum1 / listproducts_hourly['0'].totalProduct * 100;

	            jQuery.each( listproducts_hourly, function( key, listproducts_hourly ) {
	            
	             bar1 = listproducts_hourly.pricesum1 / listproducts_hourly.totalProduct * 100;
	             if(bar1 < 0.99)
	            {
	              bar = 1;
	            }
	            ...
	            {
	            	bar = listproducts_hourly.pricesum1 / listproducts_hourly.totalProduct * 100;
	            }
	             
	         
	                skutablerow+= `<tr>
	                        <td class="text-left"><img style="object-fit:cover;" width="30"  height="30" src="{{url()}}/images/product/`+listproducts_hourly.id+`/thumb/`+listproducts_hourly.thumb_photo+`">
	                        <div class="progress1" style="margin: -3% 0% 1% 5%;">
							    <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="50" style="width:`+bar+`%; /* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/#b4ddb4+0,83c783+17,52b152+33,008a00+67,005700+83,002400+100;Green+3D+%231 */
								background: #b4ddb4; /* Old browsers */
								background: -moz-linear-gradient(-45deg, #b4ddb4 0%, #83c783 17%, #52b152 33%, #008a00 67%, #005700 83%, #002400 100%); /* FF3.6-15 */
								...
								background: linear-gradient(135deg, #b4ddb4 0%,#83c783 17%,#52b152 33%,#008a00 67%,#005700 83%,#002400 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
								filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#b4ddb4', endColorstr='#002400',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */;">
						    </div><span style="color:red;"> MYR  `+ listproducts_hourly.pricedata +`</span>  
							  </div> `+listproducts_hourly.name+`</td>
	                        <td>`+listproducts_hourly.barcode+`</td>
	                        <td>`+listproducts_hourly.sku+`</td>
	                        <td>`+listproducts_hourly.npid+`</td>
	                        <td>`+listproducts_hourly.price+`</td>
	                    </tr>
	                  `;
	            });
	         } 
	...
	<div class="modal fade" id="staffSales1" role="dialog" aria-labelledby="myModalLabel" >
		<div class="modal-dialog modal-lg " role="document">

			<div class="modal-content modal-content-sku">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
           	 <h4 class="modal-title" id="myModalLabel"><b>Staff Sales</b></h4>
            ...
            <div id="staffModalBody" class="modal-body">
	            ...
	            else
	            {
	             ...
	             var i = 0
	            var k = list_staff_sales['0'].sales / list_staff_sales['0'].salesall * 100;

	            jQuery.each( list_staff_sales, function( key, list_staff_sales ) {
	           
	            
	            bar1 = list_staff_sales.sales / list_staff_sales.salesall * 100;
	            if(i == 0 )
	            {
	            	bar = 600;
	            }
	            ...
	            {
	            	bar2 = list_staff_sales.sales / list_staff_sales.salesall * 100;
	            	bar = 600/k*bar2;
	            }
	            i++;	            
	         	if(list_staff_sales.image == '')
	         	{
	         			stafftablerow+= `<tr>
	                        ...
	                        <td>`+list_staff_sales.barcode+`</td>
	                        <td>`+list_staff_sales.sku+`</td>
	                        <td>`+list_staff_sales.npid+`</td>
	                        <td>`+list_staff_sales.total+`</td>
	                    </tr>
	                  `;
	         		}
	         		else
