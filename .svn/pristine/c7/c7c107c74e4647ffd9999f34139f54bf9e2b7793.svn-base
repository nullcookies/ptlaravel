...
<style type="text/css">
	...
	<div class='row'>
		<div class='col-xs-6'><h2>Employee Master: Status</h2></div>
		<div class='col-xs-6'>
			@if(!is_null($idemployee))
				<a class="btn btn-default role_status_button pull-right add_remark" role="employee" do_status="add_remark" current_role_id="{{$idemployee->id}}" style="width: 110px !important;" href="javascript:void(0)"> Add Remark </a>
			@else
				&nbsp;
			@endif
		</div>	
...
<!--                                     <div class="form-group">
	...
	<div id="admindialog" title="Admin Approver" style="display:none">
		<p>Enter password</p>
